...
export const CellPhonePage = () => {
    ...
    //Agrupamos las viantes por color
                    ...
                    <ul className="space-y-2 ml-7 my-10">
                        {
                            product.features.map(feature => (
                                <li key={feature} className="text-sm flex items-center gap-2 tracking-tight font-medium">
                                    <span className="bg-black w-[5px] rounded-full" />
                                    {feature}
                                </li>
                            ))
                        }
                        ...
                        isOutOfStock ? (
                            ...
                            <>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex gap-8 px- py-3 border border-slate-200 w-fit rounded-full">
                                        <button>
                                            <LuMinus size={15} />
                                        </button>
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <button
                                        className="bg-black text-white font-semibold tracking-widest text-xs py-4 rounded-full"
                                    >
                                        Comprar ahora
                                    </button>
                                </div>
