    ...
    return (
        <div className="flex flex-col gap-6 relative">
            ...
            >
                ...
                <button className="bg-white border border-slate-200 absolute w-full bottom-0 rounded-3xl flex items-center justify-center gap-1 text-sm font-medium hover:bg-stone-100 translate-y-[100%] transition-all duration-300 group-hover:translate-y-0">
                    + Añadir
                </button>
            </Link>
